...
import { wordTypedActionFactory } from './store/keyboardSlice';

/**
 * Shared Redux Store communication. Both parent and child refer to the store
 */
const Keyboard3 = ({dictionary, expectedLength} : {dictionary: string[] | undefined, expectedLength: number}) => {
    ...
    function tryAcceptWord() {
        ...
        // dispach the action. this fires the thunk, the thunk creates the action and the reducer is called
